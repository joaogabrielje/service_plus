...
import { ReadonlyWrapper } from "@/components/readonly-wrapper";
  ...
  return (
    <div className="space-y-6 p-8">
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        <ReadonlyWrapper message="Você precisa estar vinculado a uma organização para criar novos usuários.">
          <a
        ...
        <ReadonlyWrapper message="Você precisa estar vinculado a uma organização para vincular outros usuários.">
          <a
